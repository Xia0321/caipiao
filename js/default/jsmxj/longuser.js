...
function myready() {
	...
	$(".query").click(function() {
		...
		parent.document.all.long.style.display = 'none';
		return false;
	});
	gets();
...
function qiu(n, t) {
	...
	if (isNaN(n) | n=='') {
		...
		if (ngid == 151 | ngid == 152 | ngid==153 | ngid==155  | ngid==157) {
			if (n > 100) {
				n = "<img src='../imgn/4_" + n.substr(-1) + ".gif' /><img src='../imgn/4_" + n.substr(-1) + ".gif' /><img src='../imgn/4_" + n.substr(-1) + ".gif' />"
			} else if (n > 10) {
				n = "<img src='../imgn/4_" + n.substr(0, 1) + ".gif' /><img src='../imgn/4_" + n.substr(-1) + ".gif' />"
			} else {
...
function query() {
	...
	var str = "&gid=" + gid + "&bid=" + bid + "&sid=" + sid + "&cid=" + cid + "&page=" + page + "&psize=" + psize;
	...
	if (bid == 'longsm') {
		$.ajax({
			...
			success: function(m) {
				...
				$(".history td").click(function() {
					//$(this).parent().find("td").toggleClass('click');
					if ($(this).hasClass('cz')) {
				...
				} else if (ngid != 121 & ngid != 123 & ngid != 125 & ngid != 161 & ngid != 162) {
		...
		$.ajax({
			...
			success: function(m) {
				...
				var pl = m[0]['m'].length;
				var qs = '';
				//var qiu = "<th>万</th><th>千</th><th>百</th><th>十</th><th>个</th>";
				if(ngid == 101 | ngid == 111 | ngid == 113 | ngid == 115 | ngid == 108 | ngid == 109 | ngid == 110 | ngid == 112){
				if (m[0]['th'][0]['bname'] == '1~5') {
					...
					str = "<tr><th>期数</th> <th>类别</th><th colspan=2 >万千</th><th colspan=2 >万百</th><th colspan=2 >万十</th><th colspan=2 >万个</th><th colspan=2 >千百</th><th colspan=2 >千十</th><th colspan=2 >千个</th><th colspan=2 >百十</th><th colspan=2 >百个</th><th colspan=2 >十个</th></tr>"
				} else if (m[0]['th'][0]['bname'] == '3字和数') {
					str = "<tr><th>期数</th> <th>类别</th><th colspan=2 >和单双</th>  <th colspan=2 >和大小</th><th colspan=2 >和尾大小</th><th colspan=2 >和尾质合</th><th>0</th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th><th>6</th><th>7</th><th>8</th><th>9</th></tr>"
					...
					if (m[0]['th'][0]['cname'] == '准对') {
						str = "<tr><th>期数</th> <th>类别</th><th>0</th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th><th>6</th><th>7</th><th>8</th><th>9</th></tr>"
					} else if (m[0]['th'][0]['cname'] == '不出') {
						str = "<tr><th>期数</th> <th>类别</th><th>0</th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th><th>6</th><th>7</th><th>8</th><th>9</th></tr>"
					} else if (m[0]['th'][0]['cname'] == '其他') {
						str = "<tr><th>期数</th> <th>类别</th><th>豹子</th><th>顺子</th><th>对子</th><th>半顺</th><th>杂六</th></tr>"
					}
				}
				} else {
